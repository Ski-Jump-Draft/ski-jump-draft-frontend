    ...
    return (
        <Card className="bg-neutral-800 border-neutral-700 text-white h-full flex flex-col overflow-hidden">
            ...
            <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar">
                <div className="grid grid-cols-[auto_1fr_auto] items-center gap-x-4 px-4 py-2 font-semibold text-sm text-gray-400 border-b border-neutral-700 sticky top-0 bg-neutral-800">
